...
class DictFormatter(logging.Formatter):
    ...
    default_regular_attrs = ["name","message","levelno","levelname","pathname","filename","module","lineno",
        ...
        "process", "processName"]
    # default_regular_attrs = ["name","message","levelname","pathname","filename","module",
    #     "funcName","created","asctime","relativeCreated","process"]
    ignore_builtin_attrs = ["args", "msg", "exc_info", "exc_text", "stack_info"]

    def __init__(self, *args, regular_attrs=None, extra_attrs=None,
                 preserve_order=False, specific_order=None, **kwargs):
        """
